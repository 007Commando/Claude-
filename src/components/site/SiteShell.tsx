...
export default function SiteShell({children}:{children:ReactNode}){const path=usePathname();return path==='/'?<>{children}</>:<MotionPage><Interior key={path}>{children}</Interior></MotionPage>}
