    ...
    <main className="bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        <motion.h1 {...fadeIn} className="text-4xl lg:text-5xl font-black tracking-tight text-slate-900 mb-5">
          Pick your VA, set the hours, start this week
        </motion.h1>
        <motion.p {...fadeIn} className="text-lg text-slate-500 max-w-2xl mx-auto">
          For sellers who already know what they need done. Choose a profile, set the schedule, and check out.
          They start within one business day.
        </motion.p>

        {/*
          The trial is the other page's job, and somebody who lands here
          without having decided should be able to get to it rather than be
          asked for a card.
        */}
