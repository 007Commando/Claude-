...
/**
 * Where the free trial goes.
 *
 * Deliberately not the Stripe checkout further down the page. A trial of a
 * person is arranged, and that button bills the first invoice immediately.
 */
const TRIAL_HREF =
  "mailto:support@apexapplications.io?subject=" +
  encodeURIComponent("Apex VA, 14 day free trial") +
  "&body=" +
  encodeURIComponent(
    "Hi Apex team,\n\nI would like to start the 14 day free trial with an Amazon VA.\n\nWhat I need help with:\n\nHours I am after each week:\n\nMy Amazon store:\n",
  );
    ...
    <main className="bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        <motion.p {...fadeIn} className="text-lg text-slate-500 max-w-2xl mx-auto">
          Not a general assistant you have to teach. Ours work inside your Apex account from day one,
          with more than 20 years of Amazon experience across the team behind them.
        </motion.p>

        {/*
          The trial is arranged rather than self-serve, so it does not point at
          the checkout below. That button opens Stripe and charges the first
          invoice, and sending somebody there under the word "free" would be a
        ...
        */}
        <motion.div {...fadeIn} className="mt-8 flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400">
            Tell us what you need done and we will match you to a VA. No card to start.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-14">
        <motion.h2 {...fadeIn} className="text-2xl font-black tracking-tight text-slate-900 mb-2 text-center">
          What your VA takes off your plate
        </motion.h2>
        <motion.p {...fadeIn} className="text-slate-500 mb-8 text-center">
          The work a wholesale business runs on, done in the software you already use.
        </motion.p>
        ...
        <p className="mt-4 text-center text-sm text-slate-400">
          And the rest of it. If it happens in your Amazon account, they have done it before.
        </p>
      </section>
      ...
      */}
      ...
      <section className="max-w-5xl mx-auto px-6 pb-14">
        ...
        <motion.p {...fadeIn} className="text-slate-500 mb-8 text-center">
          One rate, fixed. No agency margin on top and no bidding against other buyers.
        </motion.p>
