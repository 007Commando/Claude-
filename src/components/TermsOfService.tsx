  ...
  return (
    <div className="bg-white py-32 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-slate-500 mb-10">Effective Date: 2025-02-24</p>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">1. ACCESS & PASSWORDS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">2. YOUR OBLIGATIONS</h2>
          <h3 className="text-lg font-semibold text-slate-900 mt-6 mb-2">A. SUBSCRIPTIONS</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>Using the self-service functionality in your account;</li>
            <li>Requesting changes via our customer support chat; or</li>
            <li>Emailing our Support team at info@apexapplications.io.</li>
          </ul>
          <p>
          ...
          <h3 className="text-lg font-semibold text-slate-900 mt-6 mb-2">B. PAYMENTS</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-slate-900 mt-6 mb-2">C. PROHIBITED USES</h3>
          <p>The Services may only be used:</p>
          <ul className="list-disc pl-6 space-y-1">
            <li>For internal business purposes;</li>
            <li>By the number of users for whom a license has been purchased;</li>
            <li>Without unauthorized modification, combination, or exploitation with other products or software, except as expressly permitted; and</li>
            <li>In compliance with all applicable laws and our provided documentation.</li>
          </ul>
          <p>You expressly agree that you will not:</p>
          <ul className="list-disc pl-6 space-y-1">
            <li>Use the Services in any manner that could harm, disable, or impair them;</li>
            <li>Transmit viruses, malware, or other harmful code;</li>
            <li>Reverse engineer, decompile, or disassemble any portion of the Services;</li>
            <li>Resell or commercially exploit any part of the Services or access thereto;</li>
            <li>Use data from the Services for unsolicited solicitation or marketing;</li>
            <li>Access the site via automated means (e.g., scripts or crawlers);</li>
            <li>Create derivative works based on the Services;</li>
            <li>Employ framing techniques to enclose or capture any part of the Services;</li>
            <li>Mirror, cache, or store any portion of the Services;</li>
            <li>Use false or misleading identification in communications; or</li>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">3. OUR OBLIGATIONS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">4. DURATION OF TERMS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">5. THIRD PARTY CONTENT AND SERVICES</h2>
          <h3 className="text-lg font-semibold text-slate-900 mt-6 mb-2">A. AUTHORIZATION</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-slate-900 mt-6 mb-2">B. COMPANY DATA</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold text-slate-900 mt-6 mb-2">C. YOUR CUSTOMER DATA</h3>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">6. PUBLIC POSTINGS AND LICENSED MATERIALS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">7. WARRANTIES AND LIMITATIONS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">9. MODIFICATION OF TERMS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">10. MODIFICATIONS TO SERVICES</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">11. OWNERSHIP</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">12. INTERNATIONAL USERS</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">13. ARBITRATION AND CLASS ACTION WAIVER</h2>
          <p className="font-semibold text-slate-900">
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mt-10 mb-4">14. MISCELLANEOUS</h2>
          <p>
          ...
          <p className="font-semibold">Apex Applications</p>
          <p>Email: info@apexapplications.io</p>
        </div>
      </div>
    </div>
