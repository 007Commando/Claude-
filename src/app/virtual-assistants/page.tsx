          ...
          <Shell>
            <div className="items-center lg:grid lg:grid-cols-[1fr_1.2fr] lg:gap-16">
              ...
              <div className="mt-24 lg:mt-0">
                <ProductFrame
                  alt="An Apex-trained assistant working inside the Apex suite"
                  caption="Image placeholder — team or workspace photo"
                />
              </div>
            </div>
          </Shell>
          ...
          <Shell>
            <div className="items-center gap-20 lg:grid lg:grid-cols-[1fr_1.4fr]">
              ...
              <div className="mt-16 lg:mt-0">
                <ProductFrame
                  alt="SOP library documenting how this seller's business runs"
                  caption="Image placeholder — SOP library"
                />
              </div>
            </div>
          </Shell>
